...
Harness (does not pass the bar yet): `make v1-gate` writes RESULTS.md. `python3 scripts/v1_gate.py --require-bar` is the v1.0 test — it fails until a dog-held-out eval on ≥3 dogs is ≥95%.
